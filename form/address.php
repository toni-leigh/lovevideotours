<?php
    echo dump_include(array("level"=>2,"include_name"=>"address.php"));
    ...
    else
    {
        ...
        else
        {
            ...
            echo        "<div id='order_address' class='left'>";
            echo            "<input type='hidden' name='addresses_submitted' value='1'/>";
            //contact information
            echo            "<span class='address_header left'>Contact Information:</span>";
            ...
            //delivery address
            echo            "<span class='address_header left'>Delivery Address:</span>";
            ...
            //billing address
            echo            "<span class='address_header left'>Billing Address:</span>";
            ...
            echo        "<div id='order_summary' class='right'>";
            echo            "<span id='basket_total' class='left'>".format_price($totals["order"])."</span>";
            echo        "</div>";
            echo        "<input id='payment_submit' class='checkout_path_button left' type='submit' name='submit' value='pay now'/>";
            echo        "<span id='payment_reassurance' class='left'>";
            echo            "Our payments are processed by leading online payment processors who have dedicated ££££'s and years to the <span class='assurance_hightlight'>SAFE</span> and <span class='assurance_hightlight'>SECURE</span> processing of online payments. You can be <span class='assurance_hightlight'>ABSOLUTELY ASSURED</span> that they have done <span class='assurance_hightlight'>EVERYTHING POSSIBLE TO PROTECT YOU</span>.";
            echo        "</span>";
